...
bank_data_conv=json.loads(bank_data)
for bankData in bank_data_conv:
    if bankData["isActive"]==True:
        bankData["balance"]+=bankData["balance"]*0.1
bank_data_json=json.dumps(bank_data_conv)
